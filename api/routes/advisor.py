...
async def ask_advisor_question(
    ...
    try:
        ...
        if question_id == 1:
            ...
            question = "¿Cuáles son los niveles clave de soporte y resistencia?"
            answer = (
            ...
            question = "¿Cuáles son los principales factores de riesgo para esta inversión?"
            answer = (
            ...
            question = "¿Cómo influye la tendencia de largo plazo (SMA 200)?"
            answer = (
            ...
            question = "¿Qué porcentaje de mi capital debería invertir en este activo?"
            answer = (
